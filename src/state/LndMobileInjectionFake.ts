...
import { status, modifyStatus, queryScores, setScores } from "../lndmobile/fake/autopilot";
import { checkScheduledSyncWorkStatus, WorkInfo } from "../lndmobile/fake/scheduled-sync"; // TODO(hsjoberg): This could be its own injection "LndMobileScheduledSync"
