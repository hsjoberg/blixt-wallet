...
export default (variables /* : * */ = variable) => {
  ...
  itemTheme[".success"].borderColor = variables.inputBorderColor;
  itemTheme[".success"][".rounded"].borderColor = variables.inputBorderColor;
  itemTheme[".success"][".regular"].borderColor = variables.inputBorderColor;
  itemTheme[".success"][".underline"].borderColor = variables.inputBorderColor;
