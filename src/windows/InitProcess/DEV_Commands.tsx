    ...
    <Container>
      ...
      <Content style={styles.content}>
        ...
        >
          ...
          >
            <Text style={styles.buttonText}>getLocales</Text>
          </Button>
          <Button
            small
            onPress={async () => {
          ...
          <Button
            ...
            onPress={async () => {
              ...
              console.log(
                "ReactNativeElectron.getInitialURL()",
                await ReactNativeElectron.getInitialURL(),
              );
            }}
          >
            <Text style={styles.buttonText}>ReactNativeElectron.getInitialURL()</Text>
          </Button>
          <Button
            small
            onPress={async () => {
          ...
          >
            <Text style={styles.buttonText}>lndmobile.hello()</Text>
          </Button>
          ...
          >
            <Text style={styles.buttonText}>
              NativeModules.LndMobileTools.DEBUG_listFilesInDocuments()
            </Text>
          </Button>
          <Button
            small
          ...
          >
            <Text style={styles.buttonText}>
              NativeModules.LndMobileTools.DEBUG_listFilesInApplicationSupport()
            </Text>
          </Button>
          <Button
            small
          ...
          <Button
            small
            onPress={async () =>
              console.log(await NativeModules.LndMobileScheduledSync.setupScheduledSyncWork())
            }
          >
            <Text style={styles.buttonText}>setupScheduledSyncWork</Text>
          </Button>
          <Button
            small
            onPress={async () =>
              console.log(await NativeModules.LndMobileScheduledSync.removeScheduledSyncWork())
            }
          >
            <Text style={styles.buttonText}>removeScheduledSyncWork</Text>
          </Button>
          <Button
            small
            onPress={async () =>
              console.log(await NativeModules.LndMobileScheduledSync.checkScheduledSyncWorkStatus())
            }
          >
            <Text style={styles.buttonText}>checkScheduledSyncWorkStatus</Text>
          </Button>
          <Button
            small
          ...
          <Button small onPress={async () => console.log(await getTransactions(db!))}>
