...
import { DEFAULT_DUNDER_SERVER, DEFAULT_INVOICE_EXPIRY, DEFAULT_LND_LOG_LEVEL, DEFAULT_MAX_LN_FEE_PERCENTAGE, DEFAULT_NEUTRINO_NODE, DEFAULT_ROUTERRPC_ESTIMATOR, PLATFORM } from "../utils/constants";
...
export const setupApp = async () => {
  ...
  await Promise.all([
    ...
    setItemObject<string>(StorageItem.bimodalPathFindingEnabled, DEFAULT_ROUTERRPC_ESTIMATOR),
