...
export enum StorageItem {
  ...
  webDavBackupEnabled = "webDavBackupEnabled",
  webDavBackupUrl = "webDavBackupUrl",
  webDavBackupUsername = "webDavBackupUsername",
  lastWebDavBackup = "lastWebDavBackup",
...
export const clearApp = async () => {
  ...
  await Promise.all([
    ...
    removeItem(StorageItem.webDavBackupEnabled),
    removeItem(StorageItem.webDavBackupUrl),
    removeItem(StorageItem.webDavBackupUsername),
    removeItem(StorageItem.lastWebDavBackup),
...
export const setupApp = async () => {
  ...
  await Promise.all([
    ...
    setItemObject<boolean>(StorageItem.webDavBackupEnabled, false),
    setItem(StorageItem.webDavBackupUrl, ""),
    setItem(StorageItem.webDavBackupUsername, ""),
    setItemObject<number>(StorageItem.lastWebDavBackup, new Date().getTime()),
