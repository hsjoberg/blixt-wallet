...
export const setWebDavBackupPassword = async (password: string) =>
  setItem("webDavBackupPassword", password);
export const getWebDavBackupPassword = async (): Promise<string | null> =>
  getItem("webDavBackupPassword");
export const removeWebDavBackupPassword = async () => removeItem("webDavBackupPassword");
